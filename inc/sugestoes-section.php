<section class="rodape-sugestoes-bg">
  <div class="rodape-sugestoes container">
      ...
      <div class="rodape-sugestoes-form">
        <form action="<?php echo get_template_directory_uri(); ?>/enviar-sugestoes.php" class="formphp">
          <div class="rodape-sugestoes-form-2">
            <input type="text" name="nome" id="nome" placeholder="Nome" required>
          </div>
          <div class="rodape-sugestoes-form-2">
            <input type="tel" name="telefone" id="telefone" placeholder="Celular (Opcional)">
          ...
          <div class="rodape-sugestoes-form-2">
            <textarea name="mensagem" id="mensagem" placeholder="Digite aqui sua sugestão, reclamação ou elogio."></textarea> 
          </div>
